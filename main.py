...
def attack(char_name: str, char_class: str) -> str:
    """Функция расчитывает действие attack в зависимости от char_class."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция расчитывает действие defence в зависимости от char_class."""
    if char_class == 'warrior':
        return (
...
def special(char_name: str, char_class: str) -> str:
    """Функция описывает действие spesial в зависимости от char_class."""
    if char_class == 'warrior':
        return (
...
def start_training(char_name: str, char_class: str) -> str:
    """Фукнция позволяет выбирать класс персонажа и совершаемое действие."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция позволяет пользователю выбирать класс персонажа."""
    approve_choice: str = ''
    char_class: str = ''
